...
namespace TP3.NET.MVC.Controllers
{
    public class ProfessorController : Controller
    {
        ...
        public ProfessorController(MasterContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Professors != null ? 
                          ...
                          Problem("Entity set 'MasterContext.Professors'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MasterContext.Professors'  is null.");
            }
            var professor = await _context.Professors.FindAsync(id);
            if (professor != null)
            {
